...
> = {
  list: {
    ...
    glow: "shadow-[0_2px_10px_rgba(59,130,246,0.18)]",
  },
  "shopping-cart": {
    color: "emerald",
    ...
    glow: "shadow-[0_2px_10px_rgba(16,185,129,0.18)]",
  },
  plane: {
    color: "sky",
    bg: "bg-sky-500/10",
    ...
    glow: "shadow-[0_2px_10px_rgba(14,165,233,0.18)]",
  },
  home: {
    color: "orange",
    bg: "bg-orange-500/10",
    ...
    glow: "shadow-[0_2px_10px_rgba(249,115,22,0.18)]",
  },
  briefcase: {
    color: "violet",
    bg: "bg-violet-500/10",
    ...
    glow: "shadow-[0_2px_10px_rgba(139,92,246,0.18)]",
  },
  heart: {
    color: "pink",
    bg: "bg-pink-500/10",
    ...
    glow: "shadow-[0_2px_10px_rgba(236,72,153,0.18)]",
  },
};
